...
export async function POST(request: Request) {
  ...
  try {
    ...
    // Check if team_id and user_id exist
    ...
    const url = `${baseUrl}/team/member_delete`;
    ...
    if (!response.ok) {
      ...
      throw new Error(`Failed to delete team member: ${responseText}`);
    }
    ...
    console.error('\nError in team member delete route:', error);
